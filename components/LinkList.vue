        ...
        <div class="mt-6">
          <h2 class="mb-6">
            ...
            >
              ...
              <span class="inline-block">Bike & Fly.</span>
            </span>
            <span class="text-5xl font-heading font-bold"
              >Festival Westendorf</span
            >
          </h2>
          <p class="text-lg leading-relaxed max-w-prose">
            In Westendorf erwartet alle Bike- und Flugbegeisterten ein neues
            Highlight: das Bike and Fly Festival. Von 9. bis 11. August wird die
            Talstation der Alpenrosenbahn zum Treffpunkt für Abenteuerlustige
